    ...
    passport.use(
        ...
        new LocalStrategy({
            ...
            function(req, username, password, done) {
                ...
                connection.query("SELECT * FROM members WHERE username = ?", [username], function(err, rows) {
                    if (err)
                        return done(err);
                    if (rows.length) {
                        ...
                        connection.query(insertQuery, [newUserMysql.role, newUserMysql.username, newUserMysql.email, newUserMysql.password], function(err, rows) {
